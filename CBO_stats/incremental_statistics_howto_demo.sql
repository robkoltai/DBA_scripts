...
select s.notes, s.* from DBA_PART_COL_STATISTICS s where owner= 'INC';
...
select * from DBA_PART_COL_STATISTICS where owner= 'INC';

-- Sajat stat gyujtes utan minden megmarad. 3 particio 2 tabla
select * from dba_tab_modifications where table_owner = 'INC' order by 2,3;

/*
-- Ha nem lett statisztikazva megsem akkor inserteket tegyunk bele itt
-- es GOTO LABEL 85. sor
