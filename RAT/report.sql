...
DECLARE
  cap_id         NUMBER;
BEGIN
  cap_id := DBMS_WORKLOAD_REPLAY.GET_REPLAY_INFO(replay_dir => 'GRB_PF_LIVE_RAT_WORK');
...
DECLARE
  cap_id         NUMBER;
BEGIN
  cap_id := DBMS_WORKLOAD_REPLAY.GET_REPLAY_INFO(replay_dir => 'GRB_PF_LIVE_RAT_WORK', load_details => true);
  dbms_output.put_line (cap_id);
END;
/

Ezt nem kene exportalni???
dba_workloadreplays.sqlset_name:
CAP0502_REP0508_DEFAU_r_136652
...
/*
ORA-20222: Invalid Input. AWR data not found. Please import the capture's AWR snapshots using DBMS_WORKLOAD_CAPTURE.IMPORT_AWR() prior to generating the capture report.
ORA-06512: at "SYS.DBMS_WORKLOAD_CAPTURE_I", line 2043
ORA-06512: at "SYS.DBMS_WORKLOAD_CAPTURE", line 57
*/
