...
-- Configure PRIVILEGE CAPTURE and AUDIT features
*/
-- PRIVILEGE CAPTURE
...
drop public synonym KRT_CT_RESULTOFREQUEST_2;

/*
spool offaudit all on KRT_MABISZ_POLICY;                      --BM_FELADAS.KRT_MABISZ_POLICY
spool offaudit all on MABISZ_POLICY;                          --BM_FELADAS.KRT_MABISZ_POLICY                              MAS A NEV !!!!
*/
...
-- Purge unified audit trail a melo elott nem volt.
